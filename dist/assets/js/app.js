...
var worksSlider = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".ba-slider__works");
worksSlider.slick({
  ainfinite: false,
  dots: true,
  arrows: true,
...
function baMap() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#city-select').on('change', function (e) {
...
module.exports = __webpack_require__(/*! C:\Front-end\exam_03\src\assets\js\app.js */"./src/assets/js/app.js");
